        ...
        if request.method == 'POST':
            ...
            if username and password:
                ...
                if user is not None:
                    ...
                    return redirect('task_manager:login')
            else:
            ...
            if request.GET.get(REDIRECT_FIELD_NAME):
                ...
                return render(request, 'task_manager/login.html', {'user' : request.user})
    ...
    if request.user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return render(
                    request,
                    'task_manager/signup.html',
                    {'user' : request.user, 'form' : form}
                )
        else:
            form = SignUpForm()
            return render(request, 'task_manager/signup.html', {'user' : request.user, 'form' : form})
