...
class Team(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("task_manager:team_detail", kwargs={"team_id" : self.id})
...
class Task(models.Model):
    ...
    accepted_by = models.ForeignKey(UserModel, on_delete=models.SET_NULL, null=True, related_name='accepted_tasks', blank=True)
    ...
    def get_absolute_url(self):
        return reverse("task_manager:task_detail", kwargs={"task_id" : self.id})
